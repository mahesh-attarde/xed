...
/// @file xed-util-disas-elf.c
/// @brief designed to facilitate the disassembly of ELF (Executable and Linkable Format) binaries using XED
/// If the binary contains DWARF debugging information (generated by the compiler in a specific format) 
/// this example can map addresses to source code line numbers
/// making it easier to correlate the disassembled code with the original source code

#include "xed-util-disas-elf.h"  // early, to get defines
